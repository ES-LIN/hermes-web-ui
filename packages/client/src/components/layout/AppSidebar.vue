...
const selectedKey = computed(() => {
  if (route.name === "admin.session") return "admin.chat";
  if (route.name === "admin.historySession") return "admin.history";
  if (route.name === "admin.groupChatRoom") return "admin.groupChat";
...
<template>
  <aside class="sidebar" :class="{ open: appStore.sidebarOpen, collapsed: appStore.sidebarCollapsed }">
    <RouteLinkItem class="sidebar-logo" :to="{ name: 'admin.chat' }">
    ...
    <nav class="sidebar-nav">
      ...
      <div class="nav-group">
        ...
        <div v-show="!isGroupCollapsed('conversation')" class="nav-group-items">
          <RouteLinkItem class="nav-item" :to="{ name: 'admin.chat' }" :active="isNavActive('admin.chat', 'admin.session')">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
              <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
            </svg>
            <span>{{ t("sidebar.chat") }}</span>
          </RouteLinkItem>
          <RouteLinkItem class="nav-item" :to="{ name: 'admin.history' }" :active="isNavActive('admin.history', 'admin.historySession')">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <RouteLinkItem class="nav-item" :to="{ name: 'admin.groupChat' }" :active="isNavActive('admin.groupChat', 'admin.groupChatRoom')">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="nav-group">
        ...
        <div v-show="!isGroupCollapsed('agent')" class="nav-group-items">
          <RouteLinkItem class="nav-item" :to="{ name: 'admin.jobs' }" :active="selectedKey === 'admin.jobs'">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <RouteLinkItem class="nav-item" :to="{ name: 'admin.kanban' }" :active="selectedKey === 'admin.kanban'">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <RouteLinkItem class="nav-item" :to="{ name: 'admin.channels' }" :active="selectedKey === 'admin.channels'">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
              <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" />
            </svg>
            <span>{{ t("sidebar.channels") }}</span>
          </RouteLinkItem>
          <RouteLinkItem class="nav-item" :to="{ name: 'admin.skills' }" :active="selectedKey === 'admin.skills'">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <RouteLinkItem class="nav-item" :to="{ name: 'admin.plugins' }" :active="selectedKey === 'admin.plugins'">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <RouteLinkItem class="nav-item" :to="{ name: 'admin.mcp' }" :active="selectedKey === 'admin.mcp'">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
              <path d="M4 7V4h16v3" />
              <path d="M9 20h6" />
              <path d="M12 7v13" />
          ...
          <RouteLinkItem class="nav-item" :to="{ name: 'admin.memory' }" :active="selectedKey === 'admin.memory'">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
              <path d="M9 18h6" />
              <path d="M10 22h4" />
          ...
          <RouteLinkItem class="nav-item" :to="{ name: 'admin.models' }" :active="selectedKey === 'admin.models'">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="nav-group">
        ...
        <div v-show="!isGroupCollapsed('monitoring')" class="nav-group-items">
          <RouteLinkItem class="nav-item" :to="{ name: 'admin.logs' }" :active="selectedKey === 'admin.logs'">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <RouteLinkItem class="nav-item" :to="{ name: 'admin.usage' }" :active="selectedKey === 'admin.usage'">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <RouteLinkItem v-if="isSuperAdmin" class="nav-item" :to="{ name: 'admin.performance' }" :active="selectedKey === 'admin.performance'">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
              <polyline points="22 12 18 12 15 21 9 3 6 12 2 12" />
            </svg>
            <span>{{ t("sidebar.performance") }}</span>
          </RouteLinkItem>
          <RouteLinkItem class="nav-item" :to="{ name: 'admin.skillsUsage' }" :active="selectedKey === 'admin.skillsUsage'">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="nav-group">
        ...
        <div v-show="!isGroupCollapsed('tools')" class="nav-group-items">
          <RouteLinkItem v-if="hasRoute('admin.codingAgents')" class="nav-item" :to="{ name: 'admin.codingAgents' }" :active="selectedKey === 'admin.codingAgents'">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="nav-group">
        ...
        <div v-show="!isGroupCollapsed('system')" class="nav-group-items">
          <RouteLinkItem v-if="isSuperAdmin" class="nav-item" :to="{ name: 'admin.profiles' }" :active="selectedKey === 'admin.profiles'">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <RouteLinkItem class="nav-item" :to="{ name: 'admin.settings' }" :active="selectedKey === 'admin.settings'">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
              <circle cx="12" cy="12" r="3" />

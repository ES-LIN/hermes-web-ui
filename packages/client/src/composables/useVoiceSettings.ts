...
export interface VoiceSettingsData {
  ...
  mimoCloneAudioDataUrl: string // 音色复刻音频 data URL
  mimoCloneAudioName: string    // 音色复刻音频文件名
...
const ttsStreamingEnabled = ref<boolean>(load().ttsStreamingEnabled)
...
const mimoCloneAudioDataUrl = ref<string>(load().mimoCloneAudioDataUrl)
const mimoCloneAudioName = ref<string>(load().mimoCloneAudioName)
...
watch(
  [provider, webspeechVoice, openaiApiKey, openaiBaseUrl, openaiModel, openaiVoice,
   ...
   ttsStreamingEnabled, mimoApiKey, mimoBaseUrl, mimoModel, mimoVoice, mimoVoiceDesignDesc, mimoStylePrompt],
  () => {
    localStorage.setItem(STORAGE_KEY, JSON.stringify({
      ...
      ttsStreamingEnabled: ttsStreamingEnabled.value,
...
export function useVoiceSettings() {
  return {
    ...
    setTtsStreamingEnabled(v: boolean) { ttsStreamingEnabled.value = v },
    ...
    setMimoCloneAudio(dataUrl: string, name: string) {
      mimoCloneAudioDataUrl.value = dataUrl
      mimoCloneAudioName.value = name
    },
    clearMimoCloneAudio() {
      mimoCloneAudioDataUrl.value = ''
      mimoCloneAudioName.value = ''
    },
    ...
    reset() {
      ...
      ttsStreamingEnabled.value = DEFAULT.ttsStreamingEnabled
      ...
      mimoCloneAudioDataUrl.value = DEFAULT.mimoCloneAudioDataUrl
      mimoCloneAudioName.value = DEFAULT.mimoCloneAudioName

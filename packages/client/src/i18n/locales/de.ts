...
jobTriggered: 'Job ausgelost',
  ...
  settings: {
    ...
    voice: {
      ...
      ttsStreaming: 'Streaming-Wiedergabe',
      ttsStreamingHint: 'Unterstuetzte TTS-Dienste starten die Wiedergabe waehrend der Generierung. MiMo wird derzeit unterstuetzt; andere Dienste nutzen normale Wiedergabe',
      ...
      mimoCloneAudioRequired: 'Laden Sie zuerst ein Audio-Beispiel fuer die Stimmklonung hoch',
      mimoCloneAudioTypeError: 'Nur MP3- oder WAV-Audiodateien werden unterstuetzt',
      mimoCloneAudioSizeError: 'Audiodatei ist zu gross. Waehlen Sie ein kuerzeres Beispiel',
      mimoCloneAudioReadError: 'Audiodatei konnte nicht gelesen werden',

export default {
  ...
  settings: {
    ...
    voice: {
      ...
      ttsStreaming: 'Streaming playback',
      ttsStreamingHint: 'Supported TTS services start playback while generating. MiMo is supported now; other services fall back to normal playback',
      ...
      mimoCloneAudioRequired: 'Upload an audio sample before using voice clone',
      mimoCloneAudioTypeError: 'Only MP3 or WAV audio files are supported',
      mimoCloneAudioSizeError: 'Audio file is too large. Choose a shorter sample',
      mimoCloneAudioReadError: 'Failed to read audio file',

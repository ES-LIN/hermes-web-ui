...
jobTriggered: 'Job ejecutado',
  ...
  settings: {
    ...
    voice: {
      ...
      ttsStreaming: 'Reproduccion en streaming',
      ttsStreamingHint: 'Los servicios TTS compatibles empiezan a reproducir mientras generan. MiMo esta soportado; otros servicios usan reproduccion normal',
      ...
      mimoCloneAudioRequired: 'Suba una muestra de audio antes de usar la clonacion de voz',
      mimoCloneAudioTypeError: 'Solo se admiten archivos de audio MP3 o WAV',
      mimoCloneAudioSizeError: 'El archivo de audio es demasiado grande. Elija una muestra mas corta',
      mimoCloneAudioReadError: 'No se pudo leer el archivo de audio',

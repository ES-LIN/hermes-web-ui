export default {
  ...
  chat: {
    ...
    adminTestPromote: 'Push to Chat',
    adminTestClear: 'Clear Test History',
    adminTestClearConfirm: 'Clear all admin test chat history?',
    adminTestCleared: 'Cleared {count} test sessions',
    adminTestClearFailed: 'Failed to clear test history',
    adminTestPromoted: 'Pushed to chat history',
    adminTestPromoteFailed: 'Failed to push test session',
...
jobTriggered: 'Job declenche',
  ...
  settings: {
    ...
    voice: {
      ...
      ttsStreaming: 'Lecture en streaming',
      ttsStreamingHint: 'Les services TTS compatibles lisent pendant la generation. MiMo est pris en charge; les autres services utilisent la lecture normale',
      ...
      mimoCloneAudioRequired: 'Televersez un echantillon audio avant d utiliser le clonage vocal',
      mimoCloneAudioTypeError: 'Seuls les fichiers audio MP3 ou WAV sont pris en charge',
      mimoCloneAudioSizeError: 'Le fichier audio est trop volumineux. Choisissez un echantillon plus court',
      mimoCloneAudioReadError: 'Impossible de lire le fichier audio',
  ...
  changelog: {
    ...
    new_0_6_4_4: 'Route and session history checks were tightened for multi-page navigation.',
    new_0_6_4_5: 'Log viewing and server diagnostics received compatibility fixes.',
    new_0_6_4_7: 'Chat session navigation and admin tooling were refined.',

export default {
  ...
  settings: {
    ...
    voice: {
      ...
      ttsStreaming: 'ストリーミング再生',
      ttsStreamingHint: '対応する TTS サービスは生成しながら再生します。現在は MiMo に対応し、他のサービスは通常再生に戻ります',
      ...
      mimoCloneAudioRequired: '音声クローンを使う前に音声サンプルをアップロードしてください',
      mimoCloneAudioTypeError: 'MP3 または WAV 音声ファイルのみ対応しています',
      mimoCloneAudioSizeError: '音声ファイルが大きすぎます。短いサンプルを選択してください',
      mimoCloneAudioReadError: '音声ファイルを読み取れませんでした',

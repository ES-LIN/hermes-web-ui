export default {
  ...
  settings: {
    ...
    voice: {
      ...
      ttsStreaming: '스트리밍 재생',
      ttsStreamingHint: '지원되는 TTS 서비스는 생성 중에 재생을 시작합니다. 현재 MiMo를 지원하며 다른 서비스는 일반 재생을 사용합니다',
      ...
      mimoCloneAudioRequired: '음성 클론을 사용하기 전에 오디오 샘플을 업로드하세요',
      mimoCloneAudioTypeError: 'MP3 또는 WAV 오디오 파일만 지원됩니다',
      mimoCloneAudioSizeError: '오디오 파일이 너무 큽니다. 더 짧은 샘플을 선택하세요',
      mimoCloneAudioReadError: '오디오 파일을 읽지 못했습니다',

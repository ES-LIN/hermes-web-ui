...
jobTriggered: 'Job acionado',
  ...
  settings: {
    ...
    voice: {
      ...
      ttsStreaming: 'Reproducao em streaming',
      ttsStreamingHint: 'Servicos TTS compativeis iniciam a reproducao durante a geracao. MiMo e suportado agora; outros servicos usam reproducao normal',
      ...
      mimoCloneAudioRequired: 'Envie uma amostra de audio antes de usar a clonagem de voz',
      mimoCloneAudioTypeError: 'Somente arquivos de audio MP3 ou WAV sao suportados',
      mimoCloneAudioSizeError: 'O arquivo de audio e muito grande. Escolha uma amostra mais curta',
      mimoCloneAudioReadError: 'Falha ao ler o arquivo de audio',

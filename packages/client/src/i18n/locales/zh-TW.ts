export default {
  ...
  chat: {
    ...
    adminTestPromote: '推送為正式對話',
    adminTestClear: '清除測試歷史',
    adminTestClearConfirm: '確定清除全部管理頁測試對話歷史？',
    adminTestCleared: '已清除 {count} 個測試會話',
    adminTestClearFailed: '清除測試歷史失敗',
    adminTestPromoted: '已推送到正式對話歷史',
    adminTestPromoteFailed: '推送測試會話失敗',
  ...
  settings: {
    ...
    voice: {
      ...
      ttsStreaming: '串流播放',
      ttsStreamingHint: '支援的 TTS 服務會邊生成邊播放；目前 MiMo 支援，其他服務會自動使用一般播放',
      ...
      mimoCloneAudioRequired: '請先上傳用於音色複製的音訊樣本',
      mimoCloneAudioTypeError: '僅支援 MP3 或 WAV 音訊檔',
      mimoCloneAudioSizeError: '音訊檔過大，請選擇較短的樣本',
      mimoCloneAudioReadError: '讀取音訊檔失敗',
  ...
  changelog: {
    ...
    new_0_6_4_4: '路由和會話歷史檢查已加強，適配多頁面導覽。',
    new_0_6_4_5: '日誌檢視和服務端診斷相容性繼續修復。',
    new_0_6_4_7: '優化對話會話導覽和管理工具體驗。',

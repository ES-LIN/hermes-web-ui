export default {
  ...
  chat: {
    ...
    adminTestPromote: '推送为正式对话',
    adminTestClear: '清除测试历史',
    adminTestClearConfirm: '确定清除全部管理页测试对话历史？',
    adminTestCleared: '已清除 {count} 个测试会话',
    adminTestClearFailed: '清除测试历史失败',
    adminTestPromoted: '已推送到正式对话历史',
    adminTestPromoteFailed: '推送测试会话失败',
  ...
  settings: {
    ...
    voice: {
      ...
      ttsStreaming: '流式播放',
      ttsStreamingHint: '支持的 TTS 服务会边生成边播放；当前 MiMo 支持，其他服务会自动使用普通播放',
      ...
      mimoCloneAudioRequired: '请先上传用于音色复刻的音频样本',
      mimoCloneAudioTypeError: '仅支持 MP3 或 WAV 音频文件',
      mimoCloneAudioSizeError: '音频文件过大，请选择更短的样本',
      mimoCloneAudioReadError: '读取音频文件失败',
  ...
  changelog: {
    ...
    new_0_6_4_4: '路由和会话历史检查已加强，适配多页面导航。',
    new_0_6_4_5: '日志查看和服务端诊断兼容性继续修复。',
    new_0_6_4_7: '优化对话会话导航和管理工具体验。',

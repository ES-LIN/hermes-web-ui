...
import { downloadLog, fetchLogFiles, fetchLogs, type LogEntry } from '@/api/hermes/logs'
...
const exportFormat = ref<'txt' | 'json'>('txt')
  ...
  <div class="logs-view">
    <header class="page-header">
      ...
      <div class="header-actions">
        ...
        />
        <NButton size="small" secondary @click="handleDownload">{{ t('logs.download') }}</NButton>

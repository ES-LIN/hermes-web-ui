...
sessionRoutes.delete('/api/hermes/sessions/admin-test', ctrl.clearAdminTestSessions)
sessionRoutes.post('/api/hermes/sessions/admin-test/:id/promote', ctrl.promoteAdminTestSession)
